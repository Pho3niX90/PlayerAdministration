                ...
                },
{
        ...
        private void SaveKitsData()
        {
            ...
            Interface.Oxide.DataFileSystem.WriteObject("Kits2_Data", kitsData);
        }
        ...
        void SaveKits()
        {
            Interface.Oxide.DataFileSystem.WriteObject("Kits2", storedData);
        }

        void LoadData()
        {
            var kits = Interface.Oxide.DataFileSystem.GetFile("Kits2");
            try
            {
